...
@Component
public class MockDataInserter1 implements CommandLineRunner {
    private final UserRepository userRepo;
    private final CardRepository cardRepo;
    private final DeckRepository deckRepo;

    @Autowired
    public MockDataInserter1(UserRepository userRepo, CardRepository cardRepo, DeckRepository deckRepo) {
